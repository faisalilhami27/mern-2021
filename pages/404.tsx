import styles from '../styles/404-not-found.module.css';

export default function Custom404() {
  return (
    <section className={`${styles['not-found']} mx-auto jumbotron d-flex align-items-center min-vh-100`}>
      <div className="container-fluid">
        <div className="text-center">
          <svg className={styles['img-fluid']}
               width="483"
               height="300"
               viewBox="0 0 483 300"
               fill="none"
        ...
        <div className={`${styles['button-group']} ${styles['btn-homepage-cover']} d-flex flex-column mx-auto`}>
          <a className={`btn ${styles['btn-homepage']} fw-medium text-lg text-white rounded-pill`}
             href="/"
             role="button"
          >
            Homepage
