        ...
        <div className="content pt-50 pb-30 ps-30">
          ...
          <div className="menus">
            <div className="item active mb-30">
              ...
              >
                <path d="M21.9033 14.7502H14.9033V21.7502H21.9033V14.7502Z"
                      stroke="#7E8CAC"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                />
                <path d="M10.9033 14.7502H3.90332V21.7502H10.9033V14.7502Z"
                      stroke="#7E8CAC"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                />
                <path d="M21.9033 3.75024H14.9033V10.7502H21.9033V3.75024Z"
                      stroke="#7E8CAC"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                />
                <path d="M10.9033 3.75024H3.90332V10.7502H10.9033V3.75024Z"
                      stroke="#7E8CAC"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
            ...
            <div className="item mb-30">
              ...
              >
                ...
                <path
                  ...
                  strokeLinejoin="round"
                />
                <path d="M3.90332 6.41406H21.9033"
                      stroke="#7E8CAC"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              >
                <g clipPath="url(#clip0)">
                  <path
                    ...
                    strokeLinejoin="round"
                  />
                  <path d="M1.90332 10.4141H23.9033"
                        stroke="#7E8CAC"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
            ...
            <div className="item mb-30">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                />
                <path d="M12.9033 2.41406V12.4141"
                      stroke="#7E8CAC"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
