...
export default function SignUp() {
  return (
    <section className="mx-auto">
      <div className={`container ${styles['sign-up']}`}>
        <div className="row">
            ...
            <form action="">
              <div className="container-fluid mx-auto">
                ...
                <div className={`${styles['button-group']} d-flex flex-column mx-auto pt-40`}>
                  <a className={`btn ${styles['btn-sign-up']} fw-medium text-lg text-white rounded-pill mb-16`}
                     href="/sign-up-photo"
                     role="button"
                  >
                    Continue
                  </a>
                  <a className={`btn ${styles['btn-sign-in']} fw-medium text-lg color-palette-1 rounded-pill`}
                     href="/sign-in"
                     role="button"
                  >
                    Sign
          ...
          <div className={`col-xxl-7 col-lg-6 ${styles['bg-blue']} text-center pt-lg-145 pb-lg-145 d-lg-block d-none`}>
            <img src="/img/Header-9.png" width="502" height="391.21" className={`${styles['img-fluid']} pb-50`} alt=""/>
